...
package org.springframework.datastore.sql.config.oracle;
...
public class DataOrclNamespaceTests extends TestCase {
    ...
    protected void setUp() throws Exception {
        this.beanFactory = new XmlBeanFactory(new ClassPathResource("test-data-sql-namespace.xml", getClass()));
    }
    ...
    public void testUsernameProxyDataSourceDefinition() throws Exception {
        ...
        assertEquals("not the correct class", "org.springframework.datastore.sql.jdbc.support.oracle.ProxyDataSource", bean.getClass().getName());
    }
